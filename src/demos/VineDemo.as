package demos {
	...
	public class VineDemo extends DemoBase {
		...
		private var _assetNames:Array = ["vine"];
		private var _infos:Object = {
			"default" : {scale:0.5, pos:{x:600, y:500}}
		};
		private var _assetName:String;
		private var _textField1:TextField;
		private var _tid:uint;

		public function VineDemo(assetManager:AssetManager, starling:Starling = null) {
		...
		public override function start():void {
			...
			_animationState.addAnimationByName(0, "animation", true, 0);
